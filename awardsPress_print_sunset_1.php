...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Awards/Press - Print - Sunset Magazine</title>
...
<li><a href="awardsPress_print.php" class="selected">Print</a></li>
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Print - Sunset Magazine </span></div>
		<div id="content_text">
			<center>
		    <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="349" align="center"><img src="images/sunset_mag.jpg" width="145" height="191" alt="Sunset Magazine" border="1"></td>
            <td width="161" align="center">&nbsp;</td>
          </tr>
        </table>
		    <h2>2003-2004 Western Home Awards</h2>

		
		<p><b>Breckenridge, Colorado</b>
		<br>Artful planning with a sense of history</p>
		
		<table width="400" cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td width="400"><font size="-1">
			  <p><img src="images/BreckenridgeHome0803.jpg" width="400" height="251" alt="" border="0"></td>
		</tr>
		<tr>
			<td width="400"><font size="-1"><p align="right">Photo by David O'Neil</p>
			</font></td>
		</tr>
		<tr>
			<td width="400"><font size="-1"><p><b>Rows of vividly painted, gabled houses with porches front small lozenge-shaped parks.</b></p></font></td>
		</tr>
		</table>
		
		<p><b>ROCKY MOUNTAIN VILLAGE</b></p>
		</center>
		
		<p><b>Challenge:</b> Persuade the town to adopt denser development on an 85-acre site originally zoned for four large residences and design a community that's child-friendly, walkable, affordable, and authentically tied to its region. The land consisted of dredge piles left over from mining operations.</p>

		<p><b>Solution:</b> Developer David O'Neil and architects Tom Lyon and John Wolff spent three years convincing authorities that the Wellington Neighborhood, a carefully designed scheme for 122 mostly single-family residences, would enhance the town and avoid sprawl. It feels like a Currier &amp; Ives village come to life. More than 70 freestanding two-story houses in six configurations - from two-bedroom duplexes of 1,000 square feet to four-bedroom dwellings of 1,800 square feet - have been built so far.</p>

		<p><b>MERIT AWARD</b> - Wolff Lyon Architects, Boulder, CO (303/447-2786)</p>
		
		<table width="430" cellspacing="0" cellpadding="0" border="0">
		<tr>

			<td width="190" valign="top"><img src="images/BreckenridgePlan0803.jpg" width="190" height="322" alt="" border="0"></td>
			<td width="10"><img src="images/tgif.gif" width="10" height="1" alt="" border="0"></td>
			<td width="230" valign="top"><font size="-1">
			<p><b>SPECIAL EFFECT</b>

			<p><b>The houses are organized around a series of "green courts,"</b> or small parks, which establish the village character and provide safe places for children to play. Garages are on rear alleys.</p>

			<p><b>The gabled roofs, broad front porches, picket fences, and simple ornamental details</b> echo the Victorian-era architecture of historic downtown Breckenridge. Inside, each house boasts an open kitchen and family room.</p>

			<p><b>Affordability.</b> Single-family homes range from $225,000 to $395,000, less than half of the area's median. </p>
			</font></td>
		</tr>
		<tr>
			<td width="190"><font size="-1">Floor Plan by Wolff Lyon Architects
<br><b>Green areas represent parks between houses.</b></font></td>
			<td width="10"><img src="images/tgif.gif" width="10" height="1" alt="" border="0"></td>
	...
	<div id="footer">
		<p><img src="images/footer_bar.jpg" alt="footerbar" width="799" height="5"></p>
