...
and connections to the surrounding forests.</em>"</div></td>
  	...
  	<?php
			...
			$num_items = 3; // limit number of items to select
		...
		<div><a href="http://cleanslate.stanford.edu/wordpress/?feed=rss2"><img src="images/small_rss.jpg"  align="right"  padding="2" border="0" height="20" width="20" /></a></div>                        
              
                    <div id="home_right_menu_btm"></div>
				</div>
                
				<div id="home_right_pic"><a href="http://poplarhouse.blip.tv" height="15px" width="15px"><img src="images/bliptv_thumb.gif"  height="43" width="43" border="0" >"HGTV: From an old gold mine springs a 14 carat community...."  </a></div></td>
    </tr>
		</table>
<div id="home_left_lower_box">
   <!-- <p>Something precious can be found in an old mining site.<br/> Cottage Living</p>
  
  	<p>Best affordable housing on the slopes.<br/>Metropolitan Home</p>
  	
    <p>Artful planning with a sense of history.<br/>Sunset Magazine</p>  -->
