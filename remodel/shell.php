...
and connections to the surrounding forests.</em>"</div></td>
      ...
      <td align="left" valign="top">
				<div id="home_right_menu">
                 ...
                 <!--   	<ul style="margin-bottom: 6px; line-height: 1.6;">
					...
					<!--		<div style="height: 10.4em;">  -->
                    <div style="height: 173px;">
			<?php
				require_once('magpierss/rss_fetch.inc');
				
				$rss = fetch_rss("http://wellingtonbreck.wordpress.com/feed/");  
			//$rss = fetch_rss("http://cleanslate.stanford.edu/wordpress/?feed=rss2");
				...
				foreach ($rss->items as $item) {
					...
					$href = $item['link'];
					$title = $item['title'];
					echo "<li style=\"margin-top: 10px; line-height: 1.6;\" >$title</li>";
					$x = $x + 1;
					echo "<p class=\"learn_more\"><a href=\"" . $href . "\" target=\"_blank\">More... <img src=\"images/poplarhouse_blue_arrow.gif\" border=\"0\" width=\"5\" 
					alt=\"More...\"></a></p>";
				}
				echo "</ul>";
			?>
            ...
            <!--      <div style="float:right;">  -->
              ...
              <!--    <div id="rss_feed">
                  ...
                  <a href="http://wellingtonbreck.wordpress.com/feed/"><span style="font: 11px arial,helvetica,sans-serif; padding: 0; margin: 0 5px 0 15px;">RSS</span></a>
                  <a href="http://wellingtonbreck.wordpress.com/feed/"><img width="20" alt="Subscribe to Poplar House News" src="images/poplarhouse_rss_feed_logo.gif" class="rss"/></a>
                      </div>  -->
            </div> 
 ...
 <div id="home_right_menu_btm"></div>
      ...
      <div id="rss_feed">
                ...
                <div id="home_right_pic">
                
                
        <!--    <a href="community_links.htm"><img src="images/Surf_brekenridge.jpg" width="150" height="100" border="0"></a>   -->
                <a href="http://poplarhouse.blip.tv/"><img src="images/bliptv_thumb.gif"  border="0">
                </a>

<div id="home_right_pic_text">
<a href="http://poplarhouse.blip.tv/">“HGTV:  From an old gold mine springs a 14 carat community...”</a>
</div>
	...
	<div id="footer"> <img src="images/footer_bar.jpg" alt="footerbar" width="799" height="5"><br />
		<div id="copyright"> 
		  <p>Copyright 2008 Poplar Wellington, LLC   |   All Rights Reserved   |   Web site by: <a href="http://www.tridig.com" target="_blank">TriDigital, Inc. </a><br>
...
<a class="moz-txt-link-rfc2396E" href="https://ssl.">"https://ssl."</a> : <a class="moz-txt-link-rfc2396E" href="http://www.">"http://www."</a>);
