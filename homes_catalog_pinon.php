...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Pinon</title>
...
<li><a href="homes_catalog_copper_rose.php">Copper Rose</a></li>
										<li><a href="homes_catalog_pinon.php" class="selected">Pinon</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Pinon</span></div>
		<div id="content_text">
		
			<table width="550" border="0" cellspacing="0" cellpadding="10">
			<tr>
				<td width="270" class="empty"><div><img src="images/catalog_pinon_250.gif" alt="Pinon" width="250" height="191"></div>
				</td>
				<td rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
			 	<p><strong>3 bedroom, 2.5 bath</strong><br>
				<strong>2 car garage</strong><br>
              	1737 sq. ft. livable space (heated interior)<br>
              	184 sq. ft. front porch<br>
				110 sq. ft. side porch</p>
				</td></tr>
				<tr><td valign="top" class="empty">
					<ul class="homes_fix">
						<li><a href="http://www.poplarhouse.com/pdf/pinon_floor_plan.pdf">Pinon Floor plan</a> PDF (616 KB)</li>
						<li><a href="http://www.poplarhouse.com/pdf/pinon_elevations.pdf">Pinon Elevations</a> PDF (355 KB)</li>
					</ul></td>
			</tr>
		</table>
