...
<!-- RSB - www.tridig.com - last modified 07.014.2009 -->

<html>
<head>

<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Pre-Construction Special</title>
...
<div id="main">
	<div id="left_menu">
		...
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
				<ul>
                                ...
                                <!-- <li><a href="homes_specials.php" class="selected">Specials</a></li> -->
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Pre-Construction Special</span></div>
		<div id="content_text">
			<p><img src="images/front_yard.jpg" alt="Front Yard"></p>
                        <p>Purchasers who contract before September 30th will receive a $5,000  credit toward upgrades. The credit can be used toward one or more of the follow items up to $5,000:</p>
                        
          <p>Kitchen Upgrades</p>
                        <p>Upgraded Cabinets</p>
                        <ul style="padding-left: 20px;">
                            <li>Birkshire Maple</li>
                            <li>Lancaster Cherry</li>
                            <li>San Pedro Alder</li>
                        </ul>
                        <p>Upgraded GE Appliances</p>
                        <ul style="padding-left: 20px;">
                            <li>Stainless Stell Refrigerator, Dishwasher, Gas Range, Microwave</li>
                            <li>Radiant Range</li>
                            <li>Counter Width Refrigerator</li>
                        </ul>
                        <p>Granite Countertops</p>
                        <p>Upgraded Floor Coverings</p>
                            <ul style="padding-left: 20px;">
                                <li>Oak Floors extended into living room and/or bedrooms</li>
                                <li>Upgraded Carpet</li>
                            </ul>
                        <p>Bathroom upgrades</p>
                            <ul style="padding-left: 20px;">
                                <li>Kohler Archer Whirlpool / Deep tub</li>
                                <li>Custom Tile</li>
                        ...
                        <p>Style Upgrades</p>
                            <ul style="padding-left: 20px;">
                                <li>Fireplace</li>
                                <li>Interior Trim window package</li>
                            </ul>
                        <p>Landscaping</p>
                            <ul style="padding-left: 20px;">
                                <li>Sod</li>
                                <li>Irrigation Systems</li>
                                <li>Additional plant materials</li>
                            </ul>
                        <p>Additional Asphalt parking pad</p>
                        <p><i>Offer expires September 30th, 2009.</i></p>
                </div>	
	</div>	
