...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Oak</title>
				...
				<ul>
								...
								<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
									<ul class="left_sub">
										...
										<li><a href="homes_catalog_oak.php" class="selected">Oak</a></li>
...
<li><a href="homes_catalog_copper_rose.php">Copper Rose</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Oak</span></div>
		<div id="content_text">
		
		
			  <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="270" class="empty"><div><span class="double"><img src="images/catalog_oak_250.gif" alt="Oak" width="250" height="248"></span></div></td>
            <td width="240" rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
                <p><strong>3 bedroom, 2 bath</strong><br />
                  1,486 sq. ft.<br>
                  Livable space - 1,486 sq. ft. <br>
                  Front porch - 84 sq. ft. <br>
				  (with room for an optional one or two car garage)</p>
				  <p><a href="http://blip.tv/file/2338129" target="_blank">Watch a guided tour of "The Oak"</a></p></td>
          </tr>
          <tr>
            <td valign="top" class="empty"><ul class="homes_fix">
              <li><a href="pdf/oak_floor.pdf">Oak Floor Plans</a> PDF (37 KB)</li>
            <!--   <li><a href="pdf/oak_second_floor.pdf">Oak Second Floor</a> PDF (37 KB)</li> -->
            </ul></td>
          </tr>
        </table>
