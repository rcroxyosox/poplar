...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Community - Technology</title>
...
<div id="main">
	<div id="left_menu">
		...
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
				<ul>
								...
								<li><a href="community_technology.php" class="selected">Technology</a></li>
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Technology</span></div>
		<div id="content_text"> 
			<div class="double">
			    <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="border: none;" height="70" width="124"><a href="http://www.comcast.com/" target="_blank"><img src="images/logo_comcast.gif" alt="comcast" width="116" height="30" border="0"></a></td>
            </tr>
          </table>
			  <p>Comcast  <a href="http://www.comcast.com/" target="_blank"><br>
			    http://www.comcast.com<br>
			...
			<div class="double">
			    <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="border: none;" height="70" width="124">
			          <a href="http://www.qwest.com" target="_blank"><img src="images/logo_qwest.gif" alt="comcast" width="77" height="60" border="0"></a></td>
            </tr>
          </table>
				<p>Qwest <a href="http://www.qwest.com" target="_blank"><br>
				  http://www.qwest.com</a> <br>
				Local &amp; Long Distance Telephone Service  <br>
				1-800-475-75261</p>
			</div>
				</div>	
	</div>	
