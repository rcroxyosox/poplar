...
<div id="main">
	...
	<div id="content">
		...
		<div id="content_text">
			<p>Beyond the recognition, however, if one looks
			...
			<p>What makes the Wellington Neighborhood
				"real" and creates a real "sense of community
				and place?"				    </p>
			<p>Perhaps it is the award winning design --- architectural
			...
			<p>Perhaps it's the neighborhood's location within
				the town limits yet immediately adjoining the
				largest proposed open space acquisition in the
			...
			Breckenridge ski area and the Ten Mile Range.</p>
			<p> In any event, at a time when new mountain
				...
				with a real sense of community and place.
				Shortly, there will be six single family homes
				available for purchase by out-of town residents -
				-- for those who want to be part of a mountain
				community, and not just another tourist.				    </p>
			<p>A home in the neighborhood is ideal as a family
				gathering spot or for sharing, or perhaps owning,
				with family, friends and business associates.
				There are no short term rentals in the neighborhood,
				so that whatever season, you will know
				your neighbors and feel a part of this traditional
				neighborhood.				    </p>
