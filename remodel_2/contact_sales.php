...
<!-- RSB - www.tridig.com - last modified 06.15.2007 -->

<html>
<head>

<title>The Wellington Neighborhood in Breckenridge, Colorado - Contact - Sales</title>
...
<div align="center" id="topNav">
  <table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><a href="contact_sales.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('topNav_contact','','images/topNav_contact-over.gif',1); buttonMouseover(event, 'contactUs')"><img src="images/topNav_contact-over.gif" alt="Contact" name="topNav_contact" width="103" height="50" border="0"></a></td>
...
<div id="main">
	<div id="left_menu">
		<div id="left_hdr"><img src="images/left_hdr_contact.gif" alt="bird" width="88" height="20"></div>
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
				<ul>
								<li><a href="contactUs_sales.php" class="selected">Sales</a></li>
								<li><a href="contact_builder.php">Builder</a></li>
				</ul>
	</div>
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Sales</span></div>
		<div id="content_text">
		<FORM	NAME="contact_firstbank" ACTION="../cgi-bin/cgiemail/contactform.txt"  METHOD="POST" ENCTYPE="x-www-form-encoded">
			<p><b>For additional information, please contact Courtney Kenady via <a href="mailto:courtney@poplarhouse.com">email</a>, phone: 970-453-5303 or with the form below.</b></p>
			
			<p>Wellington  Neighborhood<br>
			8 Dragonfly Green<br>
	    	PO Box 4626<br>
	    	Breckenridge, CO   80424<br>
	    	<strong>970-453-5303</strong><br><br>
	    
	    By the way, we will not provide any information gathered through our web site to any third party without your consent.<br>
	    <input type="hidden" name="subject" value="Poplar House Contact Request">
			<!--<input type="hidden" name="recipient" value="kevburnsjr@yahoo.com">-->
		  <input type="hidden" name="recipient" value="courtney@poplarhouse.com, david@poplarhouse.com">
		  <input type="hidden" name="success" value="http://www.poplarhouse.com/contactform_thanks.php">
		</p>
		  <FONT SIZE=-1>*</FONT><FONT FACE="Arial" SIZE=1 COLOR=000000>FIRST NAME</FONT><BR>
		<INPUT TYPE=TEXT NAME="required-first_name" SIZE=30 MAXLENGTH=80><BR><BR>
		<FONT SIZE=-1>*</FONT><FONT FACE="Arial" SIZE=1 COLOR=000000>LAST NAME</FONT><BR>
		<INPUT TYPE=TEXT NAME="required-last_name" SIZE=30 MAXLENGTH=80><BR><BR>
		<FONT FACE="Arial" SIZE=1 COLOR=000000>PHONE NUMBER</FONT><BR>

		<INPUT TYPE=TEXT NAME="dphone" SIZE=20 MAXLENGTH=80><BR><BR>
		<FONT SIZE=-1>*</FONT><FONT FACE="Arial" SIZE=1 COLOR=000000>EMAIL</FONT><BR>
		<INPUT TYPE=TEXT NAME="required-email" SIZE=30 MAXLENGTH=80>		<br><br>

		<FONT FACE="Arial" SIZE=1 COLOR=000000>REQUESTS, COMMENTS, FEEDBACK ...</FONT><BR>
		<TEXTAREA NAME="comments" ROWS=5 COLS=70 WRAP=VIRTUAL></TEXTAREA>		<INPUT TYPE=SUBMIT NAME="B1" VALUE="Please Process Form">
		<INPUT TYPE=RESET NAME="B2" VALUE="Clear Form">
		</p></FORM>
				</div>	
	</div>	
