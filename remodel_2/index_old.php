      ...
      <td align="left" valign="top">
				<div id="home_right_menu">
					<div id="home_right_menu_top"></div>
						<ul style="margin-bottom: 6px; line-height: 1.2;">
							<li style="margin-top: 10px;"> <a href="explore_overview.php">View</a> the latest information on the second phase of the Neighborhood.</li>
						  <li style="margin-top: 8px;"> Stay tuned for more information on the reservation process.</li>
						  <li style="margin-top: 8px;"> <a href="homes_catalog.php">Check out</a> our new single family homes.</li>
						</ul>
					<div id="home_right_menu_btm"></div>
				</div>
				<div id="home_right_pic"><a href="community_links.php"><img src="images/Surf_brekenridge.jpg" width="150" height="100" border="0"></a></div></td>
    </tr>
		</table>
