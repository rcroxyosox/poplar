				...
				<ul>
					...
					<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
						<ul class="left_sub">
							...
							<li><a href="homes_catalog_ponderosa.php">Ponderosa</a></li>                            <li><a href="homes_catalog_ponderosa_plus.php">Ponderosa Plus</a></li>
<li><a href="homes_catalog_copper_rose.php">Copper Rose</a></li>
	...
	<div id="content">
		...
		<div id="content_text">
		  <table width="464" border="0" cellpadding="5" cellspacing="5">
        <tr>
          <td><a href="homes_catalog_buckthorn.php"><img src="images/catalog_buckthorn_t.gif" alt="Buckthorn" width="108" height="80" border="0"></a></td>
          <td align="left"><a href="homes_catalog_buckthorn.php">Buckthorn</a></td>
          ...
          <td align="left"><a href="homes_catalog_juniper.php">Juniper</a></td>
        </tr>
        <tr>
          <td><a href="homes_catalog_mountainAsh.php"><img src="images/catalog_mountain_ash_t.gif" alt="Mountain Ash" width="116" height="80" border="0"></a></td>
          <td align="left"><a href="homes_catalog_mountainAsh.php">Mountain Ash </a></td>
          <td><a href="homes_catalog_hawthorne.php"><img src="images/catalog_hawthorne_t.gif" alt="Hawthorne" width="89" height="70" border="0"></a></td>
          <td align="left"><a href="homes_catalog_hawthorne.php">Hawthorne</a></td>
        </tr>
        <tr>
          <td><a href="homes_catalog_oak.php"><img src="images/catalog_oak_t.gif" alt="Oak" width="71" height="70" border="0"></a></td>
          <td align="left"><a href="homes_catalog_oak.php">Oak</a></td>
          <td><a href="homes_catalog_ponderosa.php"><img src="images/catalog_ponderosa_plus_t.gif" alt="Ponderosa" width="117" height="70" border="0"></a></td>
          <td align="left"><a href="homes_catalog_ponderosa.php">Ponderosa Plus</a></td>
        </tr>
        <tr>
          <td><a href="homes_catalog_cottonwood.php"><img src="images/catalog_cottonwood_t.gif" alt="Cottonwood" width="77" height="80" border="0"></a></td>
          <td align="left"><a href="homes_catalog_cottonwood.php">Cottonwood</a></td>
          <td><a href="homes_catalog_copper_rose.php"><img src="images/catalog_copper_rose_t.gif" alt="Copper Rose" width="88" height="80" border="0"></a></td>
