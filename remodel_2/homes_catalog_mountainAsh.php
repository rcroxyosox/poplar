...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Mountain Ash</title>
				...
				<ul>
					...
					<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
						<ul class="left_sub">
							...
							<li><a href="homes_catalog_mountainAsh.php" class="selected">Mountain Ash</a></li>
...
<li><a href="homes_catalog_copper_rose.php">Copper Rose</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Mountain Ash - 2 or 3 bedroom house <span class="catalog_hdr"></span></span></div>
		<div id="content_text">
		
		
			  <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="270" class="empty"><div><span class="double"><img src="images/catalog_mountain_ash_250.gif" alt="Mountain Ash" width="250" height="172"></span></div></td>
            <td width="240" rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
                <p><strong>3 bedroom, 2 bath</strong><br>
                  1,637 Usable sq. ft.<br>
                  1,249 liviable sq. ft.(heated interior space)<br>
                  196 sq. ft. Porch<br>
                  192 sq. ft. Attic storage<br>
                  (with room for optional one or two car garage)</p>
                <p><strong>2 bedroom, 1.5 bath</strong><br>
                  1,310 Usable sq. ft.<br>
                  1,006 liviable sq. ft.(heated interior space)<br>
                  112 sq. ft. Porch<br>
                  192 sq. ft. Attic storage<br>
                  (with room for optional one car garage)<br />
            </p></td>
          </tr>
          <tr>
            <td valign="top" class="empty"><ul class="homes_fix">
              <li><a href="pdf/moun_ash_first_floor.pdf">Mountain Ash First Floor</a> PDF (408 KB)</li>
              <li><a href="pdf/moun_ash_second_floor.pdf">Mountain Ash Second Floor</a> PDF (193 KB)</li>
            </ul></td>
          </tr>
        </table>
