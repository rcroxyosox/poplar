...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Specifications</title>
...
<a class="menuItem" href="community_deedRestriction.php">&rdquo;Local Price&rdquo; Deed Restriction</a>
...
<div id="main">
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Specifications </span></div>
		<div id="content_text">
		  <p><b>Wellington Neighborhood Construction Specifications *</b></p>
		  <p><b>FOUNDATION</b></p>
		  <ul type="square">
        <li>Shallow Frost Protected w/ 2&rdquo; rigid insulation</li>
        <li>8&rdquo; Poured in place wall on a spread footer</li>
      </ul>
      <p><b>FRAMING</b></p>
      <ul type="square">
        
        <li>Engineered I-joist</li>
        <li>&frac34;&rdquo; OSB Subfloor glued and nailed</li>
        <li>2&rdquo; x 6&rdquo; Exterior walls</li>
        <li>2&rdquo; x 4&rdquo; Interior walls</li>
        <li>Pre fabricated roof truss system</li>
        <li>5/8&rdquo;  CDX plywood roof sheeting</li>
        <li>Corner duplex and garage loft flooring:  5/8&rdquo; CDX plywood</li>
      </ul>
      <p><b>EXTERIOR TRIM</b></p>
      <ul type="square">
        <li>James Hardi Plank cementeceous siding:  5&rdquo; reveal, smooth</li>
        <li>James Hardi 5/4&rdquo; fascia and belly band</li>
        <li>GPI beaded plywood porch soffit</li>
        <li>Deck posts in 8&rdquo; round, 6&rdquo; square or 4&rdquo; traditional profiles</li>
      </ul>
      <p><b>PORCHES</b></p>
      <ul type="square">
        <li>&ldquo;Smart Sense&rdquo; treated lumber deck joists</li>
        <li>Construction Heart grade redwood decking, rails &amp; caps</li>
        <li>Wood lattice under the deck<br>
        </li>
      </ul>
      <p><b>INSULATION</b></p>
      <ul type="square">
        <li>2&rdquo; Rigid foundation insulation with a scratch coat of TEIFs stucco system</li>
        <li>R-19 Fiberglas Batts in exterior walls and sloped ceilings</li>
        <li>R-11 Fiberglas Batts in interior party wall (duplex)</li>
        <li>R-30 Fiberglas Batts in flat ceilings</li>
        <li>Foam pac in exterior wall and floor penetrations</li>
      </ul>
      <p><b>WINDOWS</b></p>
      <ul type="square">
        <li>White vinyl insulated low E glass</li>
      </ul>
      <p><b>DRYWALL</b></p>
      <ul type="square">
        <li>Hand textured, square corner</li>
        <li>Dura rock tub surrounds</li>
      </ul>
      <p><b>FINISH CARPENTRY</b></p>
      <ul type="square">
        <li>Colonist 6 panel smooth hollow core doors</li>
        <li>Anderson finger joint pine FJ623 profile baseboard and door casing</li>
        <li>Clear pine or poplar window sills with 623 profile apron</li>
        <li>1&rdquo; x 4&rdquo; with 3/8&rdquo; x 1&rdquo; parting stop door headers</li>
        <li>Clear fir factory finished handrail</li>
        <li>Drop down ladders to loft in garages and corner duplex</li>
        <li>Clear pine or poplar stair skirts</li>
      </ul>
      <p><b>HARDWARE</b></p>
      <ul type="square">
        <li>Schlage Plymouth series polished brass door knobs</li>
        <li>US-34 brass door hinges</li>
        <li>Franklin Brass white porcelain towel bars and paper holder</li>
        <li>Broan 609 medicine cabinets</li>
        <li>White Manor Mirror 001846 W</li>
      </ul>
      <p><b>CABINETS</b></p>
      <ul type="square">
        <li>MasterCraft &ldquo;Concord&rdquo; series maple cabinets</li>
        <li>Laminate counter tops with tile backsplash</li>
      </ul>
      <p><b>TILE &amp; FLOORING</b></p>
      <ul type="square"><li>4&rdquo; x 4&rdquo; Dal tile back splashes and tub surrounds</li>
        <li>12&rdquo; x 12&rdquo; Mannington Vega VCT in bathrooms and back </li>
        <li>Sheet vinyl flooring in mechanical rooms</li>
      </ul>
      <p><b>WOOD FLOORING</b></p>
      <ul type="square">
        <li>#2 Red Oak finished with two coats of Poly Urethane sealer and a top coat</li>
      </ul>
      <p><b>PAINT</b></p>
      <ul type="square">
        <li>Exterior body:  Sherwin Williams Woodscapes solid base stain</li>
        <li>Exterior Trim:  Sherwin Williams Woodscapes</li>
        <li>Decks:  Sherwin Williams Deckscapes deck stain &ldquo;Cedar Bark&rdquo; </li>
        <li>Soffit:  Clear sealant</li>
        <li>Interior Walls:  Kwal Velvet sheet &ldquo;Crisp Linen&rdquo;</li>
        <li>Interior Woodwork:  Kwal semi-gloss latex enamel &ldquo;Berry White&rdquo;</li>
        <li>Foundation Stucco:  Sherwin Williams Woodscapes &ldquo;Wild County&rdquo;</li>
        
      </ul>
      <p><b>CARPET</b></p>
      <ul type="square">
        <li>Promo 35 Polyester fiber cut pile carpet over 3/8&rdquo; 6# pad</li>
        <li>Mid-grade Upgrade:  Barrier Reef Polyester fiber cut berber over 3/8&rdquo; 6# pad</li>
      </ul>
      <p><b>PLUMBING</b></p>
      <ul type="square">
        <li>PEX Water piping</li>
        <li>White china lavs</li>
        <li>Stainless steel double bowl sink sink</li>
        <li>Single lever chrome faucets</li>
        <li>Elongated bowl toilets<br>
        </li>
      </ul>
      <p><b>HEATING</b></p>
      <ul type="square">
        <li>Hydronic baseboard with PEX piping</li>
        <li>70,000 &ndash; 100,000 btu boiler</li>
        <li>4 zones per house</li>
        <li>Electronic digital thermostats</li>
        <li>50 gallon hot water heater</li>
      </ul>
      <p><b>EXTERIOR DOOR</b></p>
      <ul type="square">
        <li>Clear fir 6 panel door, lacquer finish</li>
      </ul>
      <p><b>ELECTRICAL</b></p>
      <ul type="square">
        <li>150 amp electrical service</li>
        <li>White toggle switches</li>
        <li>Door bell </li>
        <li>Chrome bar light vanity</li>
        <li>Recessed porch light fixtures</li>
        <li>Dining room tract light</li>
        <li>Surface mount globes in closets</li>
        <li>Stair sconces in the corner duplex stair</li>
        <li>Switched crawl space light</li>
        <!--<li>Heat tape water supply line (Block One)</li>-->
        <li>Cat 5 phone wire</li>
        <li>RG 6 Coaxial TV wire</li>
      </ul>
      <p><b>APPLIANCES</b></p>
      <ul type="square">
        <li>30&rdquo; Free-Standing self-cleaning Electric Range
        <li>21.8 cubic foot top-freezer refrigerator with ice maker
        <li>Dishwasher White on White 5 cycle with 2 wash levels
        <li>Standard Range Hood
        </ul>
      <p><a name="note"></a>* NOTE: THESE SPECIFICATIONS ARE ONLY MEANT TO BE REPRESENTATIVE OF THE MATERIALS AND FINISHES THAT WILL BE USED IN CONSTRUCTION OF THE RESIDENCES. THE SELLER WILL MAKE VARIOUS CHANGES AND SUBSTITUTIONS TO THE ACTUAL MATERIALS AND FINISHES USED IN RESPONSE TO CHANGES IN RESIDENCE DESIGN, MARKET CONDITIONS, AND MATERIAL/LABOR AVAILABILITY AND PRICING.</p>
				</div>	
	</div>	
	<div id="footer">
