...
<div id="main">
	...
	<div id="content">
		...
		<div id="content_text">
			<p><span class="floatRight"><img src="images/porch_street.jpg" alt="porchStreet" width="300" height="195"></span>To improve warranty service, homeowners can file warranty requests online 24/7.   Click here for a copy of the <a href="homes_warranty.php">Wellington Neighborhood Limited Warranty</a>.</p>
			<p>If your request is covered by the limited warranty, please use our <a href="http://contractor.poplarhouse.com/control/warranty.asp?addnew=true" onClick="openwin();" target="x">online warranty request form</a>.</p>
			<p>If  the warranty request constitutes an emergency situation, please call  453.5303, Extension 15 for emergency contact information.</p>
				</div>	
	</div>
