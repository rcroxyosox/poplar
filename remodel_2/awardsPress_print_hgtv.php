...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Awards/Press - Print - HGTV</title>
	...
	<div id="content">
		...
		<div id="content_text">
		 ...
		 <center>
	      ...
	      <h2>Wellington to be featured on HGTV</h2>
	    </center>
		 <p><b>By Tara Flanagan</b></p>
		 <p>In addition to getting some national exposure this past week in the form of a Lands' End catalog shoot, the Wellington Neighborhood is getting a visit next week from HGTV (Home &amp; Garden Television)--the folks who bring to the tube everything from landscaping to Easter egg design to housing trends.</p>
		 <p>It is the latter, in particular the focus on so-called smart growth, where Wellington comes in.  The neighborhood, primarily attainable housing designed with New Urbanist concepts, has been winning awards lately, among them the 2002 Smart Growth award from the EPA.</p>
		 <p>Developer David O'Neil says the HGTV segment is due to air this summer, and that the still-wintery atmosphere at the neighborhood hasn't deterred the TV crews.</p>
		 <p>He said the piece is specifically aimed at Wellington.  "We're obviously thrilled," he added.</p>
		 <p>The crews plan to be in town for two days, and according to O'Neil, will interview Wellington residents Vicki Pierpont and Katie and George Hughes about their homes and how the neighborhood is working out for them.</p>
		 <p>Breckenridge Mayor Sam Mamula is also slated for some airtime.</p> 
					</div>	
	</div>	
		<?php
