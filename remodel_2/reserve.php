...
<form action="reserve_2.php" method="get">
...
<!--<input type="hidden" name="business" value="kevburnsjr2@yahoo.com">-->
		  ...
		  <p>A limited number of homes will be built this construction  season.&nbsp; To establish your &ldquo;no risk&rdquo;  priority on the waiting list and become eligible to take advantage of a  pre-construction discount, early registration is necessary.&nbsp; Homes will be shown on a &ldquo;first come, first  serve basis&rdquo;.&nbsp;&nbsp; When you are shown a home  or homes, you may select a home, in which case you will be given an opportunity  to enter into <u><a href="pdf/master_contract.pdf">contract</a></u> negotiations; or, you may  elect to pass and your deposit will be immediately refunded.&nbsp;&nbsp;&nbsp; <br>
		    At any time you can request and will receive an immediate  full refund of your deposit.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
		  <p>Registration is accomplished by completing the following  form.&nbsp;&nbsp; A $500 <strong>fully refundable</strong> deposit (the &ldquo;Deposit&rdquo;) is due at the time of  registration.&nbsp;&nbsp; Upon acceptance of your  registration, you will receive an email from Pay Pal confirming that your  payment has cleared.&nbsp; Priority will be  established based upon the date and time of the Pay Pal confirming email.&nbsp;&nbsp;</p>
		  <p>
