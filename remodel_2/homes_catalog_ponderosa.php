...
<div id="main">
				...
				<ul>
					...
					<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
						<ul class="left_sub">
							...
							<li><a href="homes_catalog_ponderosa.php" class="selected">Ponderosa</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Ponderosa</span></div>
<div id="content_text">
		
		
			  <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="270" class="empty"><div><span class="double"><img src="images/Ponderosa-render_250.jpg" alt="Ponderosa Plus" width="250" height="169"> </span></div></td>
            <td width="240" rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
                <p><strong>3 bedrooms, 2 3/4 baths</strong><br>
				 ...
				 181 sq. ft. frontporch<br>
				 2081 usable  sq. ft.<br>
          ...
          <tr>
            <td valign="top" class="empty"><ul class="homes_fix">
              <li><a href="pdf/ponderosa_floor_plans.pdf">Ponderosa Floor plan</a> PDF (424 KB)</li>
              <li><a href="pdf/ponderosa_elevations.pdf">Ponderosa  elevations</a> PDF (246 KB)</li>
            </ul></td>
          </tr>
        </table>
