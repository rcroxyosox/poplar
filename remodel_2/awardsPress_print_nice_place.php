...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Awards/Press - Print - Nice Place</title>
<style type="text/css">
<!--
...
<div id="main">
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Print - Home Planning Ideas </span></div>
		<div id="content_text">
			
		<table width="550" border="0" cellspacing="0" cellpadding="5">
      <tr>
        <td width="357"><img src="images/press_home_cover.jpg" width="145" height="190"></td>
        <td width="173">&nbsp;</td>
      </tr>
    </table>
		<p align="center"><span class="style1">Nice Place to Live
		  Breckenridge, Colorado</span>		  </p>
		<p>From the looks of this welcoming mountain development, resplendent in
		  traditional architecture, verdant views, and community parklands, 
		  you'd never guess that the Wellington Neighborhood in Breckenridge, 
		  Colorado, was once a barren tract of land spoiled by dredge mining.
		  Residents, officials and environmental groups created this 
		  neighborhood that recycles land, creates affordable housing and 
		  provides a free transit shuttle downtown, avoiding the sprawl that's 
		  plagued its home state. Porches, alleys, open space, and trails 
		  connect the homes.</p>
		<p> Until Breckenridge reclaimed 22 acres of the site in 1972, working 
		  locals in this resort town were being squeezed out by soaring housing 
		  prices. Today 80 percent of Wellington's 122 homes are reserved for 
		  locals.  Prices for the high-country-style farmhouses range from 
		  $225,000 to $395,000.</p>
		<p> In 2002, the Environmental Protection Agency gave its Smart Growth 
		  Achievement Award to this considerate, thriving development. </p>
				</div>	
	</div>	
		<?php
