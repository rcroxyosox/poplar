...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Juniper</title>
				...
				<ul>
								...
								<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
									<ul class="left_sub">
										...
										<li><a href="homes_catalog_juniper.php" class="selected">Juniper</a></li>
...
<li><a href="homes_catalog_copper_rose.php">Copper Rose</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Juniper </span></div>
		<div id="content_text">
		
		
			  <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="270" class="empty"><div><span class="double"><img src="images/catalog_juniper_250.gif" alt="Juniper" width="250" height="288"></span></div></td>
            <td rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
			 	...
			 	<p><strong>3 bedroom, 1.75 bath</strong><br>
              	1,463 sq. ft. livable space (heated interior) <br>
              	121 sq. ft. front porch  (with room for an optional one or two car garage)</p></td>
        </tr>
          ...
          <tr>
            ...
            <td valign="top" class="empty"><ul class="homes_fix">
              <li><a href="pdf/juniper_floor_plan.pdf">Juniper Floor plan</a> PDF (428 KB)</li>
              <li><a href="pdf/juniper_elevations.pdf">Juniper Elevations</a> PDF (289 KB)</li>
            </ul></td>
