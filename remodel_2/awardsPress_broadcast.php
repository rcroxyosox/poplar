...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Awards/Press - Broadcast</title>
...
<div id="main">
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Broadcast</span></div>
		<div id="content_text">
			<div class="articles">
		    <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="184" class="empty"><img src="images/press_cpr.gif" alt="cpr logo" width="184" height="100"></td>
            <td align="center" class="empty"><p><a href="awardsPress_broadcast_public_radio.php" class="articleLink">Colorado Public Radio</a><br>
              <span class="article_title">"Colorado Matters"<br>
              </span><span class="article_description">Radio Interview</span></p>
			</td>
          </tr>
        </table>
		  </div>
		  <div class="articles">
		    <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td align="center" class="empty"><a href="awardsPress_broadcast_hgtv.php" class="articleLink">Home & Garden Television</a><br>
              <span class="article_title">Smart Growth Town</span><br>
            <span class="article_description">Nationally Aired Segment</span></td>
            <td width="184" class="empty"><img src="images/press_hgtv.jpg" alt="hgtv logo" width="184" height="100"></td>
          </tr>
        </table>
		  </div>
					</div>	
