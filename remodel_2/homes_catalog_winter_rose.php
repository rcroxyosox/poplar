...
<!-- RSB - www.tridig.com - created 06.25.2007 -->
<!-- RSB - www.tridig.com - last modified 06.03.2009 -->

<html>
<head>

<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Winter Rose</title>
...
<li><a href="homes_catalog_copper_rose.php">Copper Rose</a></li>
										...
										<li><a href="homes_catalog_winter_rose.php" class="selected">Winter Rose</a></li>
									</ul>
				  </li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Winter Rose</span></div>
		<div id="content_text">
		
			<table width="550" border="0" cellspacing="0" cellpadding="10">
			<tr>
				<td width="270" class="empty"><div><img src="images/catalog_winter_rose_250.gif" alt="Winter Rose" width="250" height="191"></div>
				</td>
				<td rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
			 	<p><strong>3 bedrooms, 2 3/4 bath</strong><br>
				2000 livable sq. ft.<br>
				203 sq.ft. front porch<br>
				280 sq. ft. back porch<br>
				2,483 usable sq. ft.<br>
				(with room for optional one or two car garage)</p>
                
		 	  <p>&nbsp;</p></td></tr>
				<tr><td valign="top" class="empty">
					<ul class="homes_fix">
						<li><a href="http://www.poplarhouse.com/pdf/winter_rose_floor_plan.pdf">Winter Rose Floor plan</a> PDF (475 KB)</li>
						<li><a href="http://www.poplarhouse.com/pdf/winter_rose_elevations.pdf">Winter Rose Elevations</a> PDF (257 KB)</li>
					</ul></td>
			</tr>
		</table>
