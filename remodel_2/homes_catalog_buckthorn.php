...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Buckthorn</title>
...
<div id="main">
		...
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
				<ul>
								...
								<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
									<ul class="left_sub">
										<li><a href="homes_catalog_buckthorn.php" class="selected">Buckthorn</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Buckthorn - 2 or 3 bedroom house</span></div>
		<div id="content_text">
		
			<table width="550" border="0" cellspacing="0" cellpadding="10">
			<tr>
				<td width="270" class="empty"><div><img src="images/catalog_buckthorn_250.gif" alt="Buckthorn" width="250" height="185"></div>
				</td>
				<td rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
					<p><strong>3 bedroom, 2 bath</strong><br />
						1,597 Usable sq. ft.<br />
						1,265 liviable sq. ft. (heated interior space)<br />
						140 sq. ft. Porch<br />
						192 sq. ft. Attic storage<br />
					(with room for optional one or two car garage)</p>
					<p><strong>2 bedroom, 1.5 bath</strong><br />
						1,322 Usable sq. ft.<br />
						1,018 liviable sq. ft. (heated interior space)<br />
						112 sq. ft. Porch<br />
						192 sq. ft. Attic storage<br />
				...
				<tr><td valign="top" class="empty">
					<ul class="homes_fix">
						<li><a href="http://www.poplarhouse.com/pdf/buckthorn_first_floor.pdf">Buckthorn First Floor</a> PDF (364 KB)</li>
						<li><a href="http://www.poplarhouse.com/pdf/buckthorn_second_floor.pdf">Buckthorn Second Floor</a> PDF (200 KB)</li>
					</ul></td>
			</tr>
		</table>
