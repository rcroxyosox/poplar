...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Contact - Builder</title>
...
<div id="main">
	<div id="left_menu">
		...
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
				<ul>
								...
								<li><a href="contact_builder.php" class="selected">Builder</a></li>
				</ul>
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Builder</span></div>
		<div id="content_text">
		  <p>The principals of Traditional  Neighborhood Builders have over 100 years of combined building experience with over 20 years of Summit County building experience.</p>
		  <p>Traditional  Neighborhood Builders<br>
		    PO Box 633 <br>
		    Frisco, CO 80443<br>
		    970-668-5075</p>
 			...
 			<p>Dan  McCrerey<br>
		    President<br>
		    <a href="mailto:dan@poplarhouse.com">dan@poplarhouse.com</a></p>
		    
		    <!--<p>Ken  Moore<br>
		    Project Manager<br>
		    <a href="mailto:ken@poplarhouse.com">ken@poplarhouse.com</a></p>-->
		    
	    	<p>Alicia  Donavon<br>
	    	Project Accounting<br>
	    	<a href="mailto:alicia@poplarhouse.com">alicia@poplarhouse.com</a></p>
				</div>	
	</div>	
	     <?php
