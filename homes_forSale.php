...
<!-- RSB - www.tridig.com - last modified 10.01.2010 -->
...
<div id="main">
	...
	<div id="content">
		...
		<h4 style="margin-bottom: 5px; margin-top: 5px;">Cottage Style Living</h4>
		...
		<h4 style="margin-bottom: 5px;">Large Single Family</h4>
		<table width="100%" border="1" cellpadding="5" cellspacing="0">
        ...
        <tr>
          ...
          <td align="center"><p><!-- PRE-CONSTRUCTION*<br> -->
			...
			Sun &amp; Incredible views</font></p></td>
          <td align="center"><p>15 Rain Drop Green, Lot 12</p></td>
        </tr>
      </table>
      <br />
     <h4 style="margin-bottom: 5px; margin-top: 5px;">Under Contract</h4>
		...
		<tr>
			...
			<tr>
			  <td width="120" align="center"><a href="homes_catalog_honeyLocust.php"><img src="images/catalog_honeylocust_t.gif" alt="Honey Locust" width="100" height="85" border="0"></a></td>
			  <td width="60" align="center"><a href="homes_catalog_honeyLocust.php">Honey Locust</a></td>
			  <td align="center" width="195"><p><font size="-1">3bed/2bath, single car garage<br />
			  				1280sqft.<br />
							Sun &amp; Incredible views</font>
				
			  </p></td>
			  <td align="center"><p>14 Leap Frog Green</p></td>
			</tr>
			<tr>
			  <td width="120" align="center"><a href="homes_catalog_winter_rose.php"><img src="images/catalog_winter_rose_t.gif" alt="Winter Rose" width="120" height="85" border="0"></a></td>
			  <td width="60" align="center"><a href="homes_catalog_winter_rose.php">Winter Rose</a></td>
			  <td align="center"><p>
				<font size="-1">3bed/2.75bath, 2000 sqft.<br>
						Incredible views!</p></td>
			  <td align="center"><p>8 Walker Green</p></td>
			</tr>
			<tr>
			  <td width="120" align="center"><a href="homes_catalog_hawthorne.php"><img src="images/catalog_hawthorne_t.gif" alt="Hawthorne" width="89" height="70" border="0"></a></td>
			  <td width="60" align="center"><a href="homes_catalog_hawthorne.php">Hawthorne</a></td>
			  ...
			  <td align="center"><p>16 Walker Green</p></td>
			</tr>
			<tr>
			  <td width="120" align="center"><a href="homes_catalog_winter_rose.php"><img src="images/catalog_winter_rose_t.gif" alt="Winter Rose" width="120" height="85" border="0"></a></td>
			  <td width="60" align="center"><a href="homes_catalog_winter_rose.php">Winter Rose</a></td>
