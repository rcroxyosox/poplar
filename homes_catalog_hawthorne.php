...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Hawthorne</title>
				...
				<ul>
								...
								<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
									<ul class="left_sub">
										...
										<li><a href="homes_catalog_hawthorne.php" class="selected">Hawthorne</a></li>
...
<li><a href="homes_catalog_copper_rose.php">Copper Rose</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Hawthorne </span></div>
		<div id="content_text">
		
		
			  <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="270" class="empty"><div><span class="double"><img src="images/catalog_hawthorne_250.gif" alt="Hawthorne" width="250" height="197"></span></div></td>
            <td width="240" rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
                ...
                <p><strong>3 bedroom, 2 bath* </strong><br>
					1,588 sq. ft.<br>
					Livable space - 1,588 sq. ft. <br>
                	Front porch - 154 sq. ft. (with room for an optional one or two car garage) <br>
					<i>*Second level bath is unfinished.</i> </p></td>
          </tr>
          <tr>
            <td class="empty"><ul class="homes_fix">
              <li><a href="pdf/hawthorne_floor.pdf">Hawthorne Floor Plans</a> PDF (39 KB)</li>
          <!--    <li><a href="pdf/hawthorne_second_floor.pdf">Hawthorne Second Floor</a> PDF (39 KB)</li> -->
            </ul></td>
          </tr>
        </table>
