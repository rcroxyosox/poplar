...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Awards/Press - Print - Metropolitan Home</title>
...
<div id="main">
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Print - Metropolitan Home </span></div>
		<div id="content_text">
			<!-- content here --> 
      ...
      <tr>
        <td width="385"><img src="images/met_home.jpg" width="238" height="300" alt="" border="0"></td>
        <td width="125">&nbsp;</td>
      </tr>
    </table>
		<h2>Design 100 - The Best of the Best: People, Places, Extraordinary Things</h2>

		</center>
		<p>Every two or three years, we like to take stock of the design world.  The result is our signature <b>Design 100</b> list.  We spend months vetting nominees, shooting photographs and laying out pages, setting as our goal a list that doesn't repeat any item we cited previously.  Readers have come to rely on the list as a chronicle of newsworthy design, from interiors and architecture to gardens, food and furnishings, from the heights of luxurious living to the most accessible kitchen gadget.  On the following pages (in no order whatsoever), you will find the 2003 version.  We hope everyone likes at least one of the hundred.  Onward! --The Editors</p>

		<center><p>* * *</p></center>
		
		
		<p><img src="images/met_photo.jpg" width="200" height="121" alt="" border="0" align="left" hspace="5"><b>89. Best Affordable Housing on the Slopes</b>
		<br>Wellington Neighborhood, Breckenridge, Colorado</p>

		 
		<p>The EPA gave this development a <a href="awardsPress_print_epa.php">National Award for Smart Growth</a> for recycling a ravaged mining site and creating affordable housing for working families in this wealthy resort community.  Jointly designed by Wolff-Lyon Architects and developer David O'Neil of Poplar House LLC, the 122 homes offer local workers an attractive alternative to a long and dangerous mountain commute.</p>
