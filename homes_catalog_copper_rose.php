...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Copper Rose</title>
...
<div id="main">
				...
				<ul>
					...
					<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
						<ul class="left_sub">
                            ...
                            <li><a href="homes_catalog_copper_rose.php" class="selected">Copper Rose</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Copper Rose</span></div>
		<div id="content_text">
		
		
			  <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="270" class="empty"><div><span class="double"><img src="images/catalog_copper_rose_250.gif" alt="Copper Rose" width="250" height="228"> </span></div></td>
            <td width="240" rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
                <p><strong>3 Bedroom 2.5 bath</strong><br>
                   1,996 sq. ft. livable space<br>
				97 sq. ft. porch<br>
				(with room for optional one or two car garage)
                </p></td>
          </tr>
          <tr>
            <td valign="top" class="empty"><ul class="homes_fix">
              <li><a href="pdf/copper_rose_floorplan.pdf">Copper Rose Floor plan</a> PDF (432 KB)</li>
            </ul></td>
          </tr>
        </table>
