...
<div id="main">
	...
	<div id="content">
		...
		<div id="content_text">
      <p><img src="images/front_yard.jpg" alt="Front Yard"><!--Mortgages are still available, despite talk of a credit crunch.--></p>
      <p>
		Wellington Neighborhood Buyers and Homeowners have a successful history getting financing and
		refinancing with reputable local lenders such as
		<a href="http://www.wellsfargo.com" target="_blank">Wells Fargo</a> and
		<a href="http://www.efirstbank.com" target="_blank">1st Bank</a>.
		The Wellington Neighborhood has had zero foreclosures with a strong, stable local community of owners.
	  </p>
	  <p>
		This recipe for success opens up mortgage opportunities for current and future buyers.  Interest rates
		are at historic lows and various mortgage options are available. For more information use our
		<a href="finance_worksheet.php">online mortgage calculator</a>
		to see what impact low interest rates have on what you can afford.
	   </p>
	   <p>For further details or if you have any questions concerning financing call Courtney
		Kenady today at 970.453.5303 ext. 703 or send an email to
		<a href="mailto:courtney@poplarhouse.com">courtney@poplarhouse.com</a>.
	   </p>
				</div>	
	</div>	
