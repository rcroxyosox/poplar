...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Explore - Vision</title>
...
<div id="main">
	<div id="left_menu">
		...
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
				<ul>
								...
								<li><a href="explore_vision.php" class="selected">Vision</a></li>
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Vision</span></div>
		<div id="content_text">
			<p>The Wellington Neighborhood has a simple vision: to create a traditional neighborhood with a sense of community and place.</p>
			<p>Our vision for the Wellington Neighborhood has five compelling objectives:</p>
				<ul>
					<li>Create sense of community within the neighborhood</li>
					<li>Establish a true sense of place by respecting the physical design patterns of a traditional neighborhood</li>
					<li>Provide needed community housing for a variety of residents</li>
					<li>Give back life to land which has been significantly disturbed by previous destructive activities</li>
					<li>Encourage sustainable development</li>
				</ul>
			
		</div>	
	</div>	
	<div id="explore_bottom_img"><img src="images/explore_bottom_img.jpg" alt="bottom image" width="600" height="125"></div>
