...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Awards/Press - Print - New Urban News</title>
...
<div id="main">
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Print - New Urban News </span></div>
		<div id="content_text">
					
		  <center>
		    <table width="550" border="0" cellspacing="0" cellpadding="5">
		      <tr>
		        <td width="500"><font size="-1"><img src="images/news_nun.jpg" width="454" height="54" alt="" border="0"></font></td>
            <td width="30">&nbsp;</td>
          </tr>
	      </table>
		    <h2>High Altitude New Urbanism</h2>
	    </center>
		  <p>Like many other ski resorts in the Rocky Mountains, Breckenridge, Colorado, is struggling with the downside of its popularity. The strong demand for second homes from wealthy city dwellers has pushed home prices to a level where even middle-income families in the community can no longer compete. Local workers commonly travel 40 or 50 miles to find an affordable home. In the Wellington Neighborhood, now under construction on a reclaimed dredge mine site one mile from downtown Breckenridge, eighty percent of the 122 homes are reserved by deed for people who work full time in the town or in Summit County.</p>
		  <p><a href="http://www.newurbannews.com" onClick="openwin()" target="_blank">New Urban News</a> - June 2001</p>
					</div>	
	</div>	
<?php
