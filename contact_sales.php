...
<!-- RSB - www.tridig.com - last modified 07.07.2009 -->
...
<div id="main">
	<div id="left_menu">
		...
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
				<ul>
								<li><a href="contact_sales.php" class="selected">Sales</a></li>
	...
	<div id="content">
		...
		<FORM	NAME="contact_firstbank" ACTION="../cgi-bin/cgiemail/contactform.txt"  METHOD="POST" ENCTYPE="x-www-form-encoded">
			<p><b>For additional information, please contact Courtney Kenady via <a href="mailto:courtney@poplarhouse.com">email</a>, phone: 970-453-5303 or at the address below:</b></p>
