...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Aspen</title>
...
<li><a href="homes_catalog_copper_rose.php">Copper Rose</a></li>
							<li><a href="homes_catalog_pinon.php">Pinon</a></li>
                                        ...
                                        <li><a href="homes_catalog_aspen.php" class="selected">Aspen</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Aspen <span class="catalog_hdr"></span></span></div>
		<div id="content_text">
		
		
			  <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="270" class="empty"><div><span class="double"><img src="images/catalog_aspen_250.gif" alt="Aspen" width="250" height="269"></span></div></td>
            <td width="240" rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
                <p><strong>2 bedroom, 1.5 bath</strong><br>
                  1,173 Usable sq. ft.<br>
                  1,173 livable sq. ft.<br>
                  112 sq. ft. Front Porch<br>
                  54 sq. ft. Rear Porch<br>
                  </p>
                <p><br />
            </p></td>
          </tr>
          <tr>
            <td valign="top" class="empty"><ul class="homes_fix">
              <li><a href="pdf/aspen_floorplan.pdf" target="_blank">Aspen Floor Plans</a> PDF (284 KB)</li>
