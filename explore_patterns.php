...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Explore - Patterns</title>
...
<div id="main">
	<div id="left_menu">
		...
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
				<ul>
								...
								<li><a href="explore_patterns.php" class="selected">Patterns</a></li>
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Patterns</span></div>
		<div id="content_text">
		  <p>The Wellington Neighborhood design approach is further expressed through a simple pattern language. This pattern language details how the overall vision will be accomplished through the site and building design.</p>
		  <ul class="double">
		    <strong>The Wellington Neighborhood has ...	      </strong>
		    <li>Safe and Plentiful Connections</li>
		    <li>A Variety of Residents, Building Types, and Uses to Make Them Whole</li>
		    <li>Buildings with Welcoming Faces</li>
		    <li>Well Defined Public Realms</li>
		  </ul>
		  <ul class="double">
		    <strong>The Wellington Neighborhood ...	      </strong>
		    <li>Helps Promote Sustainability</li>
		    <li>Respects the Historical Context of Which They Are a Part</li>
		    <li>Makes Use of Special High Country Design Solutions</li>
		  </ul>
