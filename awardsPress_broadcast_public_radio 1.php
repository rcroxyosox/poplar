...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Awards/Press - Broadcast - Colorado Public Radio</title>
...
<div id="main">
	<div id="left_menu">
		...
		<div><img src="images/corner_bird.gif" alt="bird" width="113" height="83"></div>
			<ul>
				...
				<li><a href="awardsPress_broadcast.php" class="selected">Broadcast</a></li>
		...
		<div id="quotes" style="float: left; margin-top: 15px; padding-right: 10px;">
			<a href="awardsPress_residentComments.php" style="color: #000000; text-decoration: none;">
			<?php 
	...
	<div id="content">
		<div id="content_header"><span id="content_header_underline">Broadcast - Colorado Public Radio </span></div>
		<div id="content_text">
					
		<center>
		  <h2>"Colorado Matters" Radio Interview</h2>
		</center>
		  <font size="-1">

		
		<ul>
			<li><b><a href="../radio/oneil.mov" onClick="openwin()" target="x">Listen to Interview in QuickTime Format</a></b> (2.37MB)</li>
			<li><b><a href="../radio/oneil.rm" onClick="openwin()" target="x">Listen to Interview Real Audio Format</a></b> (684KB)</li>
		</ul>
		 
		
		 <p>&nbsp;</p>
		 <center> <table width="235" cellspacing="0" cellpadding="0" border="0">
		 <tr>
		 	<td width="46"><a href="http://www.real.com/realoneplayer.phpl?pp=home&src=020819realhome_1" onClick="openwin2()" target="x"><img src="images/real.gif" width="46" height="42" alt="" border="0"></a></td>
			<td width="10"><img src="images/tgif.gif" width="10" height="1" alt="" border="0"></td>
			<td width="179"><font size="-1"><p><a href="http://www.real.com/realoneplayer.phpl?pp=home&src=020819realhome_1" onClick="openwin2()" target="_blank">Get the Real Player</a></p></td>
		 </tr>
		 <tr>
		 	<td colspan="3" width="435"><img src="images/tgif.gif" width="10" height="10" alt="" border="0"></td>		 
		 </tr>

		 <tr>
		 	<td width="46"><a href="http://www.apple.com/quicktime/download/" onClick="openwin2()" target="x"><img src="images/qt.gif" width="46" height="47" alt="" border="0"></a></td>
			<td width="10"><img src="images/tgif.gif" width="10" height="1" alt="" border="0"></td>
			<td width="179"><font size="-1"><p><a href="http://www.apple.com/quicktime/download/" onClick="openwin2()" target="_blank">Get the QuickTime Player</a></p></td>
		 </tr>
		 </table>
		 </center>
					</div>	
