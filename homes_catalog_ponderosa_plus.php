...
<title>The Wellington Neighborhood in Breckenridge, Colorado - Homes - Catalog - Ponderosa</title>
...
<div id="main">
				...
				<ul>
					...
					<li><a href="homes_catalog.php" class="selected">Home Catalog </a>
						<ul class="left_sub">
						  ...
						  <li><a href="homes_catalog_ponderosa.php">Ponderosa</a></li>                            <li><a href="homes_catalog_ponderosa.php" class="selected">Ponderosa Plus</a></li>
	...
	<div id="content">
		...
		<span id="content_header_underline">Ponderosa Plus </span></div>
		<div id="content_text">
		
		
			  <table width="550" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="270" class="empty"><div><span class="double"><img src="images/catalog_ponderosa_plus_250.gif" alt="Ponderosa Plus" width="250" height="149"> </span></div></td>
            <td width="240" rowspan="2" valign="top" class="empty"><div class="catalog_sub_hdr">Details and features:</div>
                <p><strong>3 bedrooms, 2 3/4 baths</strong><br>
                   1,900 livable sq. ft.<br>
				280 sq. ft. frontporch<br>
				2,180 usable sq. ft.
                </p></td>
          </tr>
          <tr>
            <td valign="top" class="empty"><ul class="homes_fix">
              <li><a href="pdf/ponderosa_floor_plan.pdf">Ponderosa Plus Floor plan</a> PDF (508 KB)</li>
              <li><a href="pdf/ponderosa_plus_elevations.pdf">Ponderosa Plus elevations</a> PDF (216 KB)</li>
            </ul></td>
          </tr>
        </table>
